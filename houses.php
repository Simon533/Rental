...
<div class="form-group">
<label class="control-label">House Location</label>
...
<textarea name="description" id="" cols="30" rows="4" class="form-control" required placeholder=" eg Location, accesibility"></textarea>
</div>
<div class="form-group">
...
<button class="btn btn-sm btn-default col-sm-3" type="reset" >Reset</button>
</div>
</div>
</div>
</div>
...
<div class="card">
<div class="card-header">
<b>House  available up to know</b>
</div>
<div class="card-body">
...
if(resp==1){
alert_toast("Information  successfully saved",'success')
setTimeout(function(){
location.reload()
},1500)

}
else if(resp==2){ // check whether is true
...
success:function(resp){
if(resp==1){
alert_toast("Information successfully deleted",'success')
setTimeout(function(){
location.reload()
},1500)
