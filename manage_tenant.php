...
<div class="container-fluid">
	<form action="" id="manage-tenant">
		...
		<div class="form-group row">
			...
			<div class="col-md-4">
				<label for="" class="control-label"> Reg Date</label>
				<input type="date" class="form-control" name="date_in"  value="<?php echo isset($date_in) ? date("m-d-Y",strtotime($date_in)) :'' ?>" required>
			</div>
		</div>
	</form>
</div>
