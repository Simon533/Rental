...
<b>List of  Available Tenant/s</b>
...
<tr>
	...
	<th class="">House Price</th>
	
	<th class="text-center">Action/Opearations</th>
</tr>
</thead>
<tbody>
	<button class="btn"><i class="fa fa-download"></i> Download info data</button>
<?php 
$i = 1;
...
while($row=$tenant->fetch_assoc()):
	/// try to  eneter the deatils foe modifications 
?>
